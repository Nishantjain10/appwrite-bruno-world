...
export default class Physics
{
    ...
    setCar()
    {
        ...
        this.car.options.controlsSteeringMax = Math.PI * 0.09
        this.car.options.controlsSteeringQuad = false
        this.car.options.controlsAcceleratinMaxSpeed = 0.045
        this.car.options.controlsAcceleratinMaxSpeedBoost = 0.11
        this.car.options.controlsAcceleratingSpeed = 2
        this.car.options.controlsAcceleratingSpeedBoost = 2.5
